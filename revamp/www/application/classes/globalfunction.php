...
class GlobalFunction {
	...
	public static function subCategoryImageHTML($file, array $attributes = NULL, $protocol = NULL, $index = FALSE) {
		if (LANGUAGE == Constants::LANG_EN) {
			$path = IMG_ROOT.'catimg/en/'.$file;
		}
		else {
			$path = IMG_ROOT.'catimg/zh/'.$file;
		}
		return HTML::image($path, $attributes, $protocol, $index);
	}
